...
// routing params --dynamic url
app.get("/posts/:postId", function(req,res){
  console.log("FULL URL: /posts/" + req.params.postId);  // req.params.paramName
  const requestedPost = req.params.postId;

  Post.findById(requestedPost, function(err, foundPost){
    if(!err){
  ...
  //   console.log("_.lowerCase(storedPost): " + _.lowerCase(storedPost));
